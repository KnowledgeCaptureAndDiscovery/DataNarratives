 ...
 * @author dgarijo
 */
public class DataNarrative_OLD {
...
//        this.motifAnnotations = "examples\\highlyConnectedDrugs\\motifAnnotations.ttl";
        //Workflow 1- web analytics
//        this.workflowExecutionURI="http://www.opmw.org/export/4.0/resource/WorkflowExecutionAccount/ACCOUNT-ACCESSIBILITYANA-28FE1AF0-4994-4B35-B8AE-5678E7F02B1C";
//        this.workflowTemplateURI="http://www.opmw.org/export/4.0/resource/WorkflowTemplate/ACCESSIBILITYANALYTICS-D751713988987E9331980363E24189CE";
//        this.resultURI = "http://www.opmw.org/export/4.0/resource/WorkflowExecutionArtifact/IMAGE1476147155422";
        
        //workflow 2- web analytics topic detection
        this.workflowExecutionURI="http://www.opmw.org/export/4.0/resource/WorkflowExecutionAccount/ACCOUNT-DETECTTOPICS-7A1-BF5CF914-816C-4845-AF79-A56672C4BD17";
        this.workflowTemplateURI="http://www.opmw.org/export/4.0/resource/WorkflowTemplate/DETECTTOPICS-D751713988987E9331980363E24189CE";
        this.resultURI = "http://www.opmw.org/export/4.0/resource/WorkflowExecutionArtifact/IMAGE1476159251570";
        this.doiFile = "examples\\webAnalytics\\doiAnnotations.ttl";
        this.motifAnnotations = "examples\\webAnalytics\\motifAnnotations.ttl";
//        buildKnowledgeBase();
//        //FOR LOCAL TESTS
        this.knowledgeBase = ModelFactory.createOntologyModel();
        //this.addFileToKnowledgeBase("C:\\Users\\dgarijo\\Dropbox (OEG-UPM)\\NetBeansProjects\\DatNarratives\\kb.ttl");
//        FileOutputStream out;
//        try {
//            out = new FileOutputStream("kb.ttl");
//            knowledgeBase.write(out,"TURTLE");
...
//        }
    ...
    public DataNarrative_OLD(String workflowExecutionURI, String workflowTemplateURI, String ontoSoftRepository, String stepLabelsFile, String doiFile, String motifAnnotations, String resultURI) {
...
//        }
    ...
    public String getResultName(){
        ...
        String queryResulName = "select ?name  "+Constants.unionGraph+" where{"
    ...
    public String getResultLocation(){
       String queryResulName = "select ?loc "+Constants.unionGraph+" where  {"
    ...
    public ArrayList<String> getOriginalSourcesForResult(String result){
        String q = "select ?input ?loc  "+Constants.unionGraph+" "
                + "where{"
    ...
    public String getWorkflowExecutionVisualization(){
        String queryVis = "select distinct ?vis  "+Constants.unionGraph+" where{"
    ...
    //do generic method: get value for property, and then ask if a resource has some value.
    ...
    public String getDOI(String resourceURI){
        String queryDOI = "select distinct ?doi  "+Constants.unionGraph+" where{"
    ...
    public ArrayList<String> getMotifsForProcess(String processURI){
        String queryDOI = "select distinct ?motif  "+Constants.unionGraph+" where{"
    ...
    public String getMethodName(){
        String query = "select ?wfname  "+Constants.unionGraph+" where {\n"
...
//        System.out.println(query);
    ...
    public String getMethodURI(){
        String query = "select ?temp "+Constants.unionGraph+" where {\n"
            + "<"+this.resultURI+">  <http://www.opmw.org/ontology/correspondsToTemplateArtifact> ?a.\n"
            + "?a <http://www.opmw.org/ontology/isVariableOfTemplate> ?temp.\n"
            + "}";
//        System.out.println(query);
    ...
    public ArrayList<String> getMethodInputsAndURIs(){
        String query = "select ?input ?l "+Constants.unionGraph+" where {"
    ...
    public ArrayList<String> getMethodInputsParametersAndValues(){
        String query = "select ?input ?v  "+Constants.unionGraph+" where {"
                 + "<"+this.resultURI+">  <http://openprovenance.org/model/opmo#account> ?a.\n"
                + "?input a <http://www.opmw.org/ontology/WorkflowExecutionArtifact>."
                + "?input <http://openprovenance.org/model/opmo#account> ?a."
...
//            }
     ...
     * This should be a dependency matrix!!!
     * @param m
     * @return 
     */
...
//        }
    ...
    public boolean workflowStepDependsOn(String p1, String p2){
        String query = "ASK  "+Constants.unionGraph+"  {<"+p1+"> (<http://www.opmw.org/ontology/uses>/<http://www.opmw.org/ontology/isGeneratedBy>)* <"+p2+">.}";
    ...
    public ArrayList<String> getDependenciesForWorkflowStep(String step){
        ...
        String q = "select ?step  "+Constants.unionGraph+"  "
                + "where{"
...
//        System.out.println(q);
    ...
    public String getMethodProcessForResult(String result){
        ...
        String q = "select ?step ?name  "+Constants.unionGraph+" "
                + "where{"
    ...
    public String getNameForStep(String step){
        String methodStepURIAndName="";
        String q = "select ?name "+Constants.unionGraph
                + "where{"
                + "<"+step+"> <http://www.w3.org/2000/01/rdf-schema#label> ?name."                
                + "}"; 
        ResultSet rs = GeneralMethods.queryLocalRepository(knowledgeBase, q);
    ...
    public String getProcessForArtifact(String artifact){
        String q = "select ?p  "+Constants.unionGraph
                + "where{"
    ...
    public static void main(String[] args){
        DataNarrative_OLD d = new DataNarrative_OLD();
...
//        
//        d.reorderResults(a);
        ArrayList<String> aux = d.getDependenciesForWorkflowStep("http://www.opmw.org/export/4.0/resource/WorkflowTemplateProcess/MODELTHENCLASSIFY-D751713988987E9331980363E24189CE_CLASSIFIER");
        for(String s:aux){
